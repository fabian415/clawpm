...
import { Plus, Trash2, Loader2, BarChart2, TrendingUp, Code2 } from 'lucide-vue-next'

const emit = defineEmits(['select-project', 'new-project', 'swot-project', 'market-project', 'tech-project'])
